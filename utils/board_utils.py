...
#     if len(HASHING_TO_POSITIONS_TO_MOVE) >= SIZE_LIMIT:
#         print '`HASHING_TO_POSITIONS_TO_MOVE` out of memory'
#         if VERSION == 2:
#             keys = HASHING_TO_POSITIONS_TO_MOVE.keys()
#         else:
#             keys = list(HASHING_TO_POSITIONS_TO_MOVE.keys())
#         for key in keys:
#             del HASHING_TO_POSITIONS_TO_MOVE[key]
#             if len(HASHING_TO_POSITIONS_TO_MOVE) < SIZE_LIMIT // 2:
#                 break
#
...
#
#     if len(HASHING_TO_POSITIONS_FOR_SEARCHING) >= SIZE_LIMIT:
#         print '`HASHING_TO_POSITIONS_FOR_SEARCHING` out of memory'
#         if VERSION == 2:
#             keys = HASHING_TO_POSITIONS_FOR_SEARCHING.keys()
#         else:
#             keys = list(HASHING_TO_POSITIONS_FOR_SEARCHING.keys())
#         for key in keys:
#             if key == 0:
#                 continue
#             del HASHING_TO_POSITIONS_FOR_SEARCHING[key]
#             if len(HASHING_TO_POSITIONS_FOR_SEARCHING) < SIZE_LIMIT // 2:
#                 break
...
#                 key += {None: ' '}.get(p, '_')
#         if len(HASHING_TABLE_OF_INDICES) >= SIZE_LIMIT:
#             print '`HASHING_TABLE_OF_INDICES` out of memory'
#             if VERSION == 2:
#                 keys = HASHING_TABLE_OF_INDICES.keys()
#             else:
#                 keys = list(HASHING_TABLE_OF_INDICES.keys())
#             for key in keys:
#                 del HASHING_TABLE_OF_INDICES[key]
#                 if len(HASHING_TABLE_OF_INDICES) < SIZE_LIMIT // 2:
#                     break
